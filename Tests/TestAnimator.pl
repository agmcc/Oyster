...
package Oyster::Tests::TestAnimator;
...
sub main{
	...
	my $animator = Oyster::Animator->new();
	$animator->addState($playerWalkState);
	$animator->addState($playerRunState);
	$animator->addState($playerSprintState);
	$animator->setInitialState($playerWalkState);
